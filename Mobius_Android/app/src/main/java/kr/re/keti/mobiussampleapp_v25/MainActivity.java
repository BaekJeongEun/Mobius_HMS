...
public class MainActivity extends AppCompatActivity implements Button.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public static String ServiceAEName = "mite";
...
//        Switch_MQTT.setVisibility(View.INVISIBLE);
    ...
    public void GetAEInfo() {
        ...
        //csebase.setInfo(Mobius_Address,"7579","Smite","1883");
    ...
    public void MQTT_Create(boolean mtqqStart) {
        if (mtqqStart && mqttClient == null) {
            ...
            Toast.makeText(getApplicationContext(),csebase.getMQTTPort(),Toast.LENGTH_SHORT).show();
...
//            }
                ...
                if (((ToggleButton) v).isChecked()) {
                    ...
                    req.setReceiver(new IReceived() {
                        public void getResponseBody(final String msg) {
                            handler.post(new Runnable() {
                                public void run() {
                                    //textViewData.setText("************** curtain 제어(열림) *************\r\n\r\n" + msg);
                                }
                            });
                        }
                    });
                    ...
                    req.setReceiver(new IReceived() {
                        public void getResponseBody(final String msg) {
                            handler.post(new Runnable() {
                                public void run() {
                                    //textViewData.setText("************** curtain 제어(닫힘) **************\r\n\r\n" + msg);
                                }
                            });
                        }
                    });
    ...
    class RetrieveRequest extends Thread {
        ...
        private String ContainerName = "curtain";
        ...
        public void run() {
            try {
                //String sb = "http://203.253.128.161:7579/Mobius/mite/co2/latest";
    ...
    class SubscribeResource extends Thread {
        ...
        public void run() {
            try {
                String sb = "http://203.253.128.161:7579/Mobius/mite/co2";
